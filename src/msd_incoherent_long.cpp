...
int main(int argc, char* argv[]) {
    ...
    unsigned StartStep{}, SamplingStep{}, CurrentSamplingStep{}, CurrentDtStep{}, DeltaMSDStep{} ,Step{}, NumberOfMonomers{}, BoxLength {};   
    ...
    if (argc != 9) {
        std::cout << "usage: ./msd DIRECTORY STARTSTEP DELTAMSDSTEP SAMPLINGSTEP MONOMERS DELTAT BOXLENGTH WQFILE" << std::endl;  
        return EXIT_FAILURE; 
    }      
    ...
    while (true) {
		...
		while (CurrentDtStep <= SamplingStep) {
		    //std::cout << "T1 Step: " << CurrentSamplingStep+CurrentDtStep << std::endl; 
